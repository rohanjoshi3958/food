...
POLICY: dict[str, RoutePolicy] = {
    ...
    for policy in (
        ...
        RoutePolicy(
            ...
            rationale=(
                "Reserved for FOOD-55: soft cleanup of OCR text (fix character errors, "
                "split lines). No call site yet; new code should route through this id."
            ),
        ),
        RoutePolicy(
            ...
            escalate_to=Tier.SONNET,
            rationale=(
                "Reserved for FOOD-55: food / non-food and field extraction over "
                "already-OCR'd text. No call site yet."
            ),
        ),
        RoutePolicy(
